...
Run `npm install` from root directory. This will install all dependencies for all workspaces (desktop is not in workspace). Run all these commands from root directory.
